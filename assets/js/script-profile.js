...
form.addEventListener("submit", function (e) {
    ...
    if (validEmail(email) && validPassword(password)) {
        ...
        Email.send({
            ...
            <body>
                <div>
                    ...
                    <p>
                        ...
                        avez-vous oublié que ${year} est votre année de diplomation?
                    </p>
                    <p>
                ...
                <div>
                    ...
                    <br>
                        Toutefois, nous vous recommandons, si vous le souhaitez, de modifier votre mot de passe dans les paramètres.
                    </p>
                    <p>
                       À bientôt <br>
                    </p>
            ...
            console.log(error)
            alert("Le mail n'a pas été envoyé, veuillez réessayer.")
        })
    }
})
